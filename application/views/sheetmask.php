...
<div class="content">
	<div class="container">
		<div class="col-md-4 w3ls_dresses_grid_left">
			...
			<div class="w3ls_dresses_grid_left_grid">
				<div class="dresses_img_hover">
					<img src="<?php echo base_url(); ?>assets/images/diskonsheet.jpg" alt=" " class="img-responsive" />
					<div class="dresses_img_hover_pos">
						<h4>Upto<span>10%</span><i>Off</i></h4>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="col-md-8 col-sm-8 women-dresses">
			<?php foreach ($sheetmask as $key ) { ?>
			
			<div class="">
				<div class="col-md-4 women-grids wp1 animated wow slideInUp" data-wow-delay=".5s">
					<a href="<?php echo base_url('Sheetmask/detail_produk/'.$key->id_produk); ?>"><div class="product-img">
						<img src="<?php echo base_url(); ?>assets/images/<?php echo $key->gambar;?>" alt="" />
						<div class="p-mask">
							<form action="<?php 
											if ($this->session->userdata('isLogin')==TRUE) {
												echo base_url('Sheetmask/tambah_cart');
											}
											else {
