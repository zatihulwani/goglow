...
<div class="header-bottom-w3ls">
	<div class="container">
			...
			<nav class="navbar navbar-default">
				...
				<div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
					<ul class="nav navbar-nav ">
						<li class=" active"><a href="<?php echo base_url(''); ?>Home" class="hyper "><span>Home</span></a></li>	
						<li class="dropdown ">
						...
						<li><a href="<?php echo base_url(''); ?>Home/about" class="hyper"><span>About</span></a></li>
		...
		<div class="col-md-1 cart-wthree">
			<div class="cart"> 
				<form action="<?php echo base_url(''); ?>keranjang" method="post" class="last"> 
